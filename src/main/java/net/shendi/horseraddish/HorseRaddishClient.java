...
@Mod(value = HorseRaddish.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = HorseRaddish.MODID, value = Dist.CLIENT)
public class HorseRaddishClient {
    public HorseRaddishClient(ModContainer container) {
